...
/* If connection to database, run sql statement. */
	...
	$item = "desc_fuente_financiamiento";
	$valor = this->$_POST['key']; 

	$clientes = Controladorfuentefinanciamiento::ctrBuscarfuentefinanciamiento($item, $valor);

	foreach ($fuentefinanciamiento as $row => $value) {
