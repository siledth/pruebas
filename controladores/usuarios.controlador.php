...
class ControladorUsuarios{
	...
	/*=============================================
	INGRESO DE USUARIO print_r($tabla);
	=============================================*/
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						$_SESSION["nombreente"] = $respuesta["nombreente"];
						$_SESSION["id_codio_onapre"] = $respuesta["id_codio_onapre"];
						$_SESSION["id_entes"] = $respuesta["id_entes"];
						$_SESSION["rif"] = $respuesta["rif"];
						$_SESSION["tipo_rif"] = $respuesta["tipo_rif"];
	...
	static public function ctrMostrarUsuarios($item, $valor){
		...
		/*=============================================
	MOSTRAR unidad en el registro de usuario
	=============================================*/

	static public function ctrMostrarEnte($item, $valor){

		$tabla = "entes";

		$respuesta = ModeloUsuarios::MdlMostrarEntes($tabla, $item, $valor);
	...
	/*=============================================
	MOSTRAR ESTO NO VA ACA HAY QUE CAMBIARLO
	=============================================*/
	...
	static public function ctrMostrarprogramacion($item, $valor){
		...
		$respuesta = ModeloUsuarios::MdlMostrarprogramacion($tabla, $item, $valor);
