...
class ControladorClientes{
	...
	static public function ctrMostrarCentralizada($item, $valor){

		$tabla = "view_accion_centralizada";

		$respuesta = ModeloClientes::mdlMostrarCentralizada($tabla, $item, $valor);
	...
	static public function ctrMostraraccioncentralizada($item, $valor,$ite,$it){
		...
		$respuesta = ModeloClientes::mdlMostraraccion($tabla, $item, $valor,$ite, $it);
