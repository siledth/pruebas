  ...
  global $referencia;
	...
	$this->Ln(4);    
	 ...
	 $this->Ln(4); $this->Cell(200); $this->Cell(30,30,"FECHA DE IMPRESIÓN: ".date("j-m-Y"),0,0,'L');   
	       $this->Cell(100);
	$this->Ln(4); $this->Cell(100);  $this->Cell(30,30,' Reporte Proyectos  ' ,0,0,'L');   
...
$rest="SELECT * FROM programacionanual_proyecto WHERE id_programacion_anual='".$iditm."'";		
 $re = pg_query($rest);
$i = 1;  
while($f1 = pg_fetch_array($re))
 {    $pdf->Cell(10); $pdf->Cell(60,5,'Partida Presupuestaria',0,0,'D');
	...
	$pdf->Cell(-30); $pdf->Cell(60,5,'especificación',0,0,'D');
