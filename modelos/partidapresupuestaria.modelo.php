...
class Modelopartidapresupuestaria{
...
//	var_dump($datos);
	...
	static public function mdlMostrarpartidapresupuestaria($tabla, $item, $valor){
...
/*=============================================
	...
	static public function mdlMostrarproduc($tabla, $item, $valor){
	...
	static public function mdlMostrarpartidapresupuestariaAjax(){



		$stmt = Conexion::conectar()->prepare("SELECT  
		                                             id_partida_presupuestaria,
													 codigopartida_presupuestaria,
													 desc_partida_presupuestaria as text
