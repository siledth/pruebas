...
class Modelofuentefinanciamiento{
...
//	var_dump($datos);
	...
	static public function mdlMostrarfuentefinanciamiento($tabla, $item, $valor){
	...
	static public function mdlMostrarfuentefinanciamientoAjax(){



		$stmt = Conexion::conectar()->prepare("SELECT  
		                                             id_fuente_financiamiento,
													 desc_fuente_financiamiento as text
