                ...
                <select class="form-control input-lg" name="nuevoPerfil" id="nuevoPerfil">
                  ...
                  <option value="">Selecionar perfil</option>
                    ...
                    <?php
                      ...
                      $perfiles = ControladorPerfiles::ctrMostrarPerfile($item, $valor);
 ...
 <!-- ENTRADA PARA SELECCIONAR SU PERFIL -->
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoente" id="nuevoente">
                  
                  <option value="">Selecionar -Organismo o Entes</option>
                    ...
                    <?php
                      ...
                      $perfiles = ControladorUsuarios::ctrMostrarEnte($item, $valor);

                       foreach ($perfiles as $key => $value) {

                         echo '<option value="'.$value["id_entes"].'">'.$value["nombre"].'</option>';
