    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <?php
          ...
          $categorias = Controladorproyecto::ctrMostrarproyecto($item, $valor, it);
            ...
            echo ' <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditaraccion" idCategoria="'.$value["id_proyecto"].'" data-toggle="modal" data-target="#modalEditarCategoria"><i class="fa fa-pencil">Agregar Items</i></button>
						';
 ...
 <div class="box-body">
       ...
       <?php
         $it= $_POST["idCategoria"];
          ...
          $categorias = Controladorproyecto::ctrMostraritems($item, $valor, it);
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        if($_SESSION["perfil"] == "1"){
                          ...
                          echo '<button class="btn btn-danger btnEliminarCategoria" idCategoria="'.$value["id_programacion_anual_move"].'"><i class="fa fa-times"></i></button>';
