      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        $valor = null;
          ...
          $categorias = ControladorUsuarios::ctrMostrarprogramacion($item, $valor);
          ...
          foreach ($categorias as $key => $value) {
            ...
            echo ' <tr>
                    ...
                    <td class="text-uppercase">'.$value["id_programacion_anual"].'</td>
					<td class="text-uppercase">'.$value["trimestre"].'</td>
					 <td class="text-uppercase">'.$value["name_proyecto"].'</td>
					 <td class="text-uppercase">'.$value["monto_partida"].'</td>
					 <td class="text-uppercase">'.$value["precio_total"].'</td>
