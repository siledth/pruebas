...
<table id="example1" class="table table-bordered table-striped">
                   ...
                   $res="SELECT * FROM programacion_compras_move1 WHERE id_accion_centra='$iditm' ORDER BY id_programacion_anual_move ASC ";  
                   $re = pg_query( $res );
    ...
    //  if($_SESSION["perfil"] == "1"){ 
                        ...
                        echo '<a href=index.php?ruta=eliminaraccion&codigo='.$fila['id_programacion_anual_move'].'&variable2='.$fila['id_accion_centra'].'>eliminar</a>';
         //    }
                                          echo "    </center>     </td>
                                                    </tr>";
