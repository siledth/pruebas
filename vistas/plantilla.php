  ...
  if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok"){
   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      //echo 'la ruta get es: '. $_GET["ruta"] ;

      if($_GET["ruta"] == "inicio" ||
         $_GET["ruta"] == "administrarprogramacion" ||
         $_GET["ruta"] == "usuarios" ||
         $_GET["ruta"] == "categorias" ||
         $_GET["ruta"] == "productos" ||
         $_GET["ruta"] == "accioncentralizada" ||
         $_GET["ruta"] == "ventas" ||
         $_GET["ruta"] == "crear-venta" ||
         $_GET["ruta"] == "editar-venta" ||
         $_GET["ruta"] == "reportes" ||
         $_GET["ruta"] == "datosEmpresa" ||
         $_GET["ruta"] == "crearprogramacion" ||
         $_GET["ruta"] == "programacionanual" ||
         $_GET["ruta"] == "guardarprogramacion" ||
		 $_GET["ruta"] == "anualprograma" ||
		 $_GET["ruta"] == "configurarCorreo" ||
         $_GET["ruta"] == "editar-cotizacion" ||
         $_GET["ruta"] == "centralizada" ||
         $_GET["ruta"] == "bitacora" ||
         ...
         $_GET["ruta"] == "eliminar" ||
		 //$_GET["ruta"] == "reportex" ||
         $_GET["ruta"] == "veritemaccion" ||
         $_GET["ruta"] == "eliminaraccion" ||
         $_GET["ruta"] == "anualprograma2" ||
         $_GET["ruta"] == "itemcentralizado" || 
         $_GET["ruta"] == "partidapresupuestaria" ||
         $_GET["ruta"] == "ventasProductos" ||
		// $_GET["ruta"] == "reporteorden" ||  
...
<script src="vistas/js/accioncentralizada.js"></script>
<script src="vistas/js/usuarios.js"></script>
<script src="vistas/js/categorias.js"></script>
<script src="vistas/js/productos.js"></script>
<script src="vistas/js/clientes.js"></script>
<script src="vistas/js/fuentefinanciamiento.js"></script>
