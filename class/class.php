...
where id_contenido_evaluacion_desempeno='3';";
	...
	//print_r($_POST); // pruebo que recoge datos
		...
		$sql3="insert into entes values (default, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'usuario', ?, ?, ?);";
		   ...
		   $stmt->bindValue(11,$_POST["direccion_fiscal"], PDO::PARAM_STR);
		   $stmt->bindValue(12,$_POST["pagina_web"], PDO::PARAM_STR);
		   $stmt->bindValue(13,$_POST["correo"], PDO::PARAM_STR);
		//  var_dump($stmt);
	    //  exit($stmt);
		   $stmt->execute();
		  // $t++;
		  ...
		  public function add5()// agrego desempeno nuevos 
		{
