...
where id_contenido_evaluacion_desempeno='3';";
	...
	public function add()//solicitud cuenta dante nuevo
		...
		$sql="insert into reg values (default,?,?,?,?,?,?,?,?,?,?,?,?,?,'cuentadante',1,2,1,now());";
		   ...
		   $stmt->execute();
		   $this->dbh=null;
		   header("location: acontratarcn/login.php");
		 }
	...
	//print_r($_POST); // pruebo que recoge datos
		...
		$sql3="insert into entes values (default, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'usuario', ?, ?, ?);";
		   ...
		   $stmt->bindValue(6,$_POST["id_municipio"], PDO::PARAM_STR);
		   $stmt->bindValue(7,$_POST["rif"], PDO::PARAM_STR);
		   $stmt->bindValue(8,$_POST["tipo_rif"], PDO::PARAM_STR);
		   $stmt->bindValue(9,$_POST["siglas"], PDO::PARAM_STR);
		  // $stmt->bindValue(10,$_POST["desc_ente"], PDO::PARAM_STR);
		   $stmt->bindValue(10,$_POST["direccion_fiscal"], PDO::PARAM_STR);
		   $stmt->bindValue(11,$_POST["pagina_web"], PDO::PARAM_STR);
		   $stmt->bindValue(12,$_POST["correo"], PDO::PARAM_STR);
		//  var_dump($stmt);
	    //  exit($stmt);
		   $stmt->execute();
		  // $t++;
		   ...
		   $this->dbh=null;
		   header("location: http://localhost:/contrataciones1/reistroente.php");
		 }
		  public function add5()// agrego entes nuevos 
		{
